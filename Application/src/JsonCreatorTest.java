...
public class JsonCreatorTest {
	...
	public JSONObject mockSecondEntry() {
		...
		((List<LinkedHashMap<String, Object>>) ((HashMap) ((ArrayList) jsonData.get("Categories")).get(0))
				.get("Children")).add(entry);
		return jsonData;
	}
	...
	public JSONObject mockThirdEntry() {
		...
		entry.put("Children", new ArrayList<LinkedHashMap<String, Object>>());
		((ArrayList<LinkedHashMap<String, Object>>) ((List<LinkedHashMap<String, Object>>) ((HashMap) ((ArrayList) jsonObject
				.get("Categories")).get(0)).get("Children")).get(0).get("Children")).add(entry);
		return jsonObject;
